...
namespace OOO_Telecom_Neva_Svyaz {
    ...
    public partial class ws02DataSet : global::System.Data.DataSet {
        ...
        public partial class SotrudnikDataTable : global::System.Data.TypedTableBase<SotrudnikRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public SotrudnikRow AddSotrudnikRow(string FIO, string Dolznost, string Photo) {
        ...
        public partial class SotrudnikRow : global::System.Data.DataRow {
            ...
            public string Dolznost {
                get {
                    try {
                        return ((string)(this[this.tableSotrudnik.DolznostColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'Dolznost\' в таблице \'Sotrudnik\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tableSotrudnik.DolznostColumn] = value;
                }
            }
            ...
            public string Photo {
                get {
                    try {
                        return ((string)(this[this.tableSotrudnik.PhotoColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsDolznostNull() {
                return this.IsNull(this.tableSotrudnik.DolznostColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetDolznostNull() {
                this[this.tableSotrudnik.DolznostColumn] = global::System.Convert.DBNull;
            }
...
namespace OOO_Telecom_Neva_Svyaz.ws02DataSetTableAdapters {
    ...
    public partial class SotrudnikTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Sotrudnik] WHERE (([Id_Sotrudnik] = @Original_Id_Sotrudnik) AND ((@IsNull_FIO = 1 AND [FIO] IS NULL) OR ([FIO] = @Original_FIO)) AND ((@IsNull_Dolznost = 1 AND [Dolznost] IS NULL) OR ([Dolznost] = @Original_Dolznost)) AND ((@IsNull_Photo = 1 AND [Photo] IS NULL) OR ([Photo] = @Original_Photo)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sotrudnik] ([FIO], [Dolznost], [Photo]) VALUES (@FIO, @Dolznos" +
                "t, @Photo);\r\nSELECT Id_Sotrudnik, FIO, Dolznost, Photo FROM Sotrudnik WHERE (Id_" +
                "Sotrudnik = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sotrudnik] SET [FIO] = @FIO, [Dolznost] = @Dolznost, [Photo] = @Photo WHERE (([Id_Sotrudnik] = @Original_Id_Sotrudnik) AND ((@IsNull_FIO = 1 AND [FIO] IS NULL) OR ([FIO] = @Original_FIO)) AND ((@IsNull_Dolznost = 1 AND [Dolznost] IS NULL) OR ([Dolznost] = @Original_Dolznost)) AND ((@IsNull_Photo = 1 AND [Photo] IS NULL) OR ([Photo] = @Original_Photo)));
SELECT Id_Sotrudnik, FIO, Dolznost, Photo FROM Sotrudnik WHERE (Id_Sotrudnik = @Id_Sotrudnik)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id_Sotrudnik, FIO, Dolznost, Photo FROM dbo.Sotrudnik";
        ...
        public virtual int Fill(ws02DataSet.SotrudnikDataTable dataTable) {
        ...
        public virtual ws02DataSet.SotrudnikDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ws02DataSet.SotrudnikDataTable dataTable = new ws02DataSet.SotrudnikDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ws02DataSet.SotrudnikDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Id_Sotrudnik, string Original_FIO, string Original_Dolznost, string Original_Photo) {
        ...
        public virtual int Insert(string FIO, string Dolznost, string Photo) {
            if ((FIO == null)) {
            ...
            if ((Dolznost == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[1].Value = ((string)(Dolznost));
            }
            if ((Photo == null)) {
        ...
        public virtual int Update(string FIO, string Dolznost, string Photo, int Original_Id_Sotrudnik, string Original_FIO, string Original_Dolznost, string Original_Photo, int Id_Sotrudnik) {
            if ((FIO == null)) {
            ...
            if ((Dolznost == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(Dolznost));
            }
            if ((Photo == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_Id_Sotrudnik));
            if ((Original_FIO == null)) {
            ...
            if ((Original_Dolznost == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_Dolznost));
            }
            if ((Original_Photo == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[10].Value = ((int)(Id_Sotrudnik));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FIO, string Dolznost, string Photo, int Original_Id_Sotrudnik, string Original_FIO, string Original_Dolznost, string Original_Photo) {
            return this.Update(FIO, Dolznost, Photo, Original_Id_Sotrudnik, Original_FIO, Original_Dolznost, Original_Photo, Original_Id_Sotrudnik);
        }
    }
